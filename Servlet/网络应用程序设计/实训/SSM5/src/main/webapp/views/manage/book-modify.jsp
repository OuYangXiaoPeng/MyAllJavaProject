            ...
            <form action="modifyBook.do" method="post">
                ...
                <table class="form">
                    <tr>
                        ...
                        <td><input type="text" class="text" name="bookName" value="${book.bname}"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="text" name="price" value="${book.price}"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="date" class="text" name="date" value="${book.date}"/></td>
                    </tr>
                    <tr>
                        <td class="field">类型：</td>
                        <td><input type="text" class="text" name="type" value="${book.type}"/></td>
                    </tr>
                    <tr>
                        <td class="field">图片：</td>
                        <td><input type="text" class="text" name="photo" value="${book.image}"/></td>
                    </tr>
                    <tr>
                        <td class="field">库存：</td>
                        <td><input type="text" class="text" name="store" value="${book.store}"/></td>
                    </tr>
